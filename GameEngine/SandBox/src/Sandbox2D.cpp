...
void Sandbox2D::OnUpdate(GameEngine::Timestep ts)
{
...

	{
		...
		GameEngine::Renderer2D::DrawRotatedQuad({ -2.0f,  2.0f }, { 0.8f, 0.8f }, -45.0f, { 0.8f, 0.2f, 0.3f, 1.0f });
		...
		GameEngine::Renderer2D::DrawRotatedQuad({ 0.0f, 0.0f, -0.1f }, { 10.0f, 10.0f }, 45.0f, m_CheckerboardTexture, 10.0f, glm::vec4(1.0f, 0.9f, 0.3f, 1.0f));
